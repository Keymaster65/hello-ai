...
. *Vom Build erzwungen* – jede Schicht ist ein eigenes Gradle-Modul unter `:modules:backend`
  ...
  link:{adr}/0013-ein-gradle-modul-je-schicht.md[ADR 0013] und
  link:{adr}/0014-schichtmodule-unter-backend.md[ADR 0014] sowie
  link:{adr}/0015-alle-bausteine-unter-modules.md[ADR 0015].
