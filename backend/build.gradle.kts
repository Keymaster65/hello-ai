...
// Keep the artifact name independent of the module name, so the deployable stays
// recipe-backend-<version>.jar after the move into :backend (see ADR 0011).
...
// ---------------------------------------------------------------------------
// The npm project stays at the repository root, next to this module.
